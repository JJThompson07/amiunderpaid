...
export const RECRUITER_TERRITORIES_USA: USALocation[] = [
  { id: 201, gov_name: 'Alabama', name: 'Alabama' },
  { id: 202, gov_name: 'Alaska', name: 'Alaska' },
  { id: 203, gov_name: 'Arizona', name: 'Arizona' },
  { id: 204, gov_name: 'Arkansas', name: 'Arkansas' },
  { id: 205, gov_name: 'California', name: 'California' },
  { id: 206, gov_name: 'Colorado', name: 'Colorado' },
  { id: 207, gov_name: 'Connecticut', name: 'Connecticut' },
  { id: 208, gov_name: 'Delaware', name: 'Delaware' },
  { id: 209, gov_name: 'District of Columbia', name: 'District of Columbia' },
  { id: 210, gov_name: 'Florida', name: 'Florida' },
  { id: 211, gov_name: 'Georgia', name: 'Georgia' },
  { id: 212, gov_name: 'Guam', name: 'Guam' },
  { id: 213, gov_name: 'Hawaii', name: 'Hawaii' },
  { id: 214, gov_name: 'Idaho', name: 'Idaho' },
  { id: 215, gov_name: 'Illinois', name: 'Illinois' },
  { id: 216, gov_name: 'Indiana', name: 'Indiana' },
  { id: 217, gov_name: 'Iowa', name: 'Iowa' },
  { id: 218, gov_name: 'Kansas', name: 'Kansas' },
  { id: 219, gov_name: 'Kentucky', name: 'Kentucky' },
  { id: 220, gov_name: 'Louisiana', name: 'Louisiana' },
  { id: 221, gov_name: 'Maine', name: 'Maine' },
  { id: 222, gov_name: 'Maryland', name: 'Maryland' },
  { id: 223, gov_name: 'Massachusetts', name: 'Massachusetts' },
  { id: 224, gov_name: 'Michigan', name: 'Michigan' },
  { id: 225, gov_name: 'Minnesota', name: 'Minnesota' },
  { id: 226, gov_name: 'Mississippi', name: 'Mississippi' },
  { id: 227, gov_name: 'Missouri', name: 'Missouri' },
  { id: 228, gov_name: 'Montana', name: 'Montana' },
  { id: 229, gov_name: 'Nebraska', name: 'Nebraska' },
  { id: 230, gov_name: 'Nevada', name: 'Nevada' },
  { id: 231, gov_name: 'New Hampshire', name: 'New Hampshire' },
  { id: 232, gov_name: 'New Jersey', name: 'New Jersey' },
  { id: 233, gov_name: 'New Mexico', name: 'New Mexico' },
  { id: 234, gov_name: 'New York', name: 'New York' },
  { id: 235, gov_name: 'North Carolina', name: 'North Carolina' },
  { id: 236, gov_name: 'North Dakota', name: 'North Dakota' },
  { id: 237, gov_name: 'Ohio', name: 'Ohio' },
  { id: 238, gov_name: 'Oklahoma', name: 'Oklahoma' },
  { id: 239, gov_name: 'Oregon', name: 'Oregon' },
  { id: 240, gov_name: 'Pennsylvania', name: 'Pennsylvania' },
  { id: 241, gov_name: 'Puerto Rico', name: 'Puerto Rico' },
  { id: 242, gov_name: 'Rhode Island', name: 'Rhode Island' },
  { id: 243, gov_name: 'South Carolina', name: 'South Carolina' },
  { id: 244, gov_name: 'South Dakota', name: 'South Dakota' },
  { id: 245, gov_name: 'Tennessee', name: 'Tennessee' },
  { id: 246, gov_name: 'Texas', name: 'Texas' },
  { id: 247, gov_name: 'Utah', name: 'Utah' },
  { id: 248, gov_name: 'Vermont', name: 'Vermont' },
  { id: 249, gov_name: 'Virgin Islands', name: 'Virgin Islands' },
  { id: 250, gov_name: 'Virginia', name: 'Virginia' },
  { id: 251, gov_name: 'Washington', name: 'Washington' },
  { id: 252, gov_name: 'West Virginia', name: 'West Virginia' },
  { id: 253, gov_name: 'Wisconsin', name: 'Wisconsin' },
  { id: 254, gov_name: 'Wyoming', name: 'Wyoming' }
];
