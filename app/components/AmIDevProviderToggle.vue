<template>
  <div class="fixed bottom-4 right-4 z-[9999] flex flex-col items-end gap-3 font-sans">
    ...
    >
      <div v-if="isOpen" class="w-72 bg-white/95 backdrop-blur-xl shadow-2xl rounded-2xl p-4 border border-slate-200">
        <h4 class="text-[0.65rem] font-bold text-slate-400 uppercase tracking-widest mb-3 px-1">Dev Tools</h4>
        <AmITabs
          v-model="override"
