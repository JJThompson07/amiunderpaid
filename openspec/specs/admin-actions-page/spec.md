...
Provide a robust `admin-actions.vue` control panel, featuring modular action cards and a unified visual logging console for monitoring server tasks in real-time.
