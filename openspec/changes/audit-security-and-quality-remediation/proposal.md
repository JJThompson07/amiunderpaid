...
- `firestore-rules`: Update Requirement "User profile write restrictions" and "Strict profile field protection" to include `ukNationalStatus`, `usaNationalStatus`, and `claims` in the client write blacklist.
