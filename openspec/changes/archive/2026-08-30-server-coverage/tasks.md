...
- [x] 2.2 Delete the bullet point note that says: *"Note: Server API routes (`server/**`) currently have a relaxed starting threshold of 0%. When modifying or adding new server endpoints, you MUST write corresponding unit tests to establish coverage."*
