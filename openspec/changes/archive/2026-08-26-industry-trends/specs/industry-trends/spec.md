...
_Added post-archive — see this change's `proposal.md` "Post-Archive Follow-Up" and `design.md` decision 8. Already synced to `openspec/specs/industry-trends/spec.md`; kept here too for this archived change's own historical record._
...
_Added post-archive — see design.md decision 9._
...
_Added post-archive — see design.md decision 10._
